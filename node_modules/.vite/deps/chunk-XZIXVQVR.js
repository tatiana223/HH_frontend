...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react14.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function useTransition({
  ...
  const isInitialRef = (0, import_react15.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react15.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react15.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react16.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react16.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react16.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react16.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react16.useState)(!show);
  const lastFocusRef = (0, import_react16.useRef)(null);
  (0, import_react16.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react16.useRef)();
  const removeKeydownListenerRef = (0, import_react16.useRef)();
...
var Fade = React12.forwardRef(({
  ...
  const handleEnter = (0, import_react17.useCallback)((node, isAppearing) => {
...
var AbstractModalHeader = React17.forwardRef(({
  ...
  const context = (0, import_react18.useContext)(ModalContext_default);
...
var Offcanvas = React21.forwardRef(({
  ...
  const modalManager = (0, import_react19.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react19.useState)(false);
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime18.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React22.forwardRef(({
  ...
  const context = (0, import_react20.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var Navbar = React24.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react21.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react21.useMemo)(() => ({
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-XZIXVQVR.js.map
